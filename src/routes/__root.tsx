...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Ravito met en relation les bénévoles passionnés et les organisateurs sportifs en France." },
      { property: "og:site_name", content: "Ravito" },
      { property: "og:title", content: "Ravito — Bénévoles pour événements sportifs en France" },
      { property: "og:description", content: "Ravito met en relation les bénévoles passionnés et les organisateurs sportifs en France." },
      { property: "og:type", content: "website" },
      { name: "theme-color", content: "#73CC30" },
      { name: "twitter:title", content: "Ravito — Bénévoles pour événements sportifs en France" },
      { name: "twitter:description", content: "Ravito met en relation les bénévoles passionnés et les organisateurs sportifs en France." },
