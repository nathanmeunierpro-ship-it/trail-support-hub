  ...
  head: () => ({
    meta: [
      { title: "Publie ton événement et trouve tes bénévoles — Ravito" },
      {
        name: "description",
        content:
          "Trail, running, cyclosportive, triathlon — crée ton annonce et reçois des candidatures de bénévoles motivés partout en France.",
      },
    ],
  }),
  component: OrgPage,
...
const FEATURES = [
  {
    ...
    title: "Démarre gratuitement",
    desc: "Offre Starter offerte aux 20 premiers organisateurs. Aucune carte requise.",
  },
  {
    icon: <Filter size={22} />,
    ...
    <PageShell>
      <section className="px-6 py-16">
        <div className="mx-auto max-w-4xl">
          ...
          >
            <Link to="/organisateurs/comment-ca-marche" className="btn-cta inline-flex items-center gap-2">
