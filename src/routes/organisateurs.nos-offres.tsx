...
const OFFERS: Offer[] = [
  ...
  },
  {
    ...
    badgeClass: "bg-white text-[var(--primary)]",
  },
  {
    name: "Premium",
    ...
    bgClass: "bg-white",
    textClass: "text-foreground",
    badgeClass: "bg-[var(--primary)]/15 text-[var(--primary)]",
  },
];
                ...
                <ul className="space-y-3 mb-8 flex-1">
                  {o.features.map((f) => (
                    <li key={f} className="flex items-start gap-2 text-sm leading-relaxed">
                      <Check
                        size={16}
                        className={`mt-0.5 shrink-0 ${o.highlighted ? "text-white" : "text-[var(--primary)]"}`}
                      />
                      <span>{f}</span>
                    </li>
                  ))}
                ...
                {o.ctaKind === "link" && o.ctaHref ? (
                  <Link
                    ...
                    className={`inline-flex items-center justify-center gap-2 rounded-full px-5 py-3 text-sm font-bold uppercase tracking-wider transition-opacity hover:opacity-90 ${
                      o.highlighted ? "bg-white text-[var(--primary)]" : "bg-[var(--primary)] text-white"
                    }`}
                  >
            ...
            <div className="p-6 sm:p-8">
              ...
              {sent ? (
                <div className="text-center py-10">
                  ...
                  <button
                    onClick={handleClose}
                    className="inline-flex items-center justify-center rounded-full px-6 py-3 text-sm font-bold uppercase tracking-wider bg-[var(--primary)] text-white hover:opacity-90"
                  >
                    Fermer
                  </button>
                </div>
                ...
                <form onSubmit={submit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={sending}
                    className="w-full inline-flex items-center justify-center gap-2 rounded-full px-5 py-3.5 text-sm font-bold uppercase tracking-wider bg-[var(--primary)] text-white hover:opacity-90 transition-opacity disabled:opacity-60 disabled:cursor-not-allowed"
                  >
...
function inputCls(hasError: boolean) {
  ...
  } bg-white px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/30 focus:border-[var(--primary)] transition-colors`;
}
