...
export const TYPES_SPORT = ["Trail", "Running", "Triathlon", "Cyclosportive", "Autre"] as const;
export const MISSIONS = ["Balisage", "Ravitaillement", "Accueil", "Sécurité", "Chronométrage"] as const;

export const DEPARTEMENTS_FR: { code: string; nom: string }[] = [
